...
function getOrderHomeList(vm){//查询
  wx.request({
    url: app.url + '/v1/order/getOrderHomeList',
      ...
      if (res.data.code == '10000') {
        ...
        if (data.length<1){
          ...
          vm.setData({
            ...
            var thisData = vm.data.orderHomeList.concat(data);
            var thisPageNumber = vm.data.pageNumber;
            thisPageNumber++;
            vm.setData({
              orderHomeList: thisData,
